...
class MustangAalu extends StatefulWidget {
  const MustangAalu({super.key});

  @override
  State<MustangAalu> createState() => _MustangAaluState();
}

class _MustangAaluState extends State<MustangAalu> {
  int a = 1;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Material(
                            color: const Color.fromARGB(255, 237, 194, 66),
                            elevation: 10,
                            borderRadius: BorderRadius.circular(100),
                            child: Image.asset(
                              "assets/images/mustang_aalu.png",
                          ...
                          children: [
                            Expanded(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Mustang Aalu", style: AppWidget.headlineTextFieldStyle()),
                                  Text(
                                    "Authenticate taste of Mustang aalu & \nperfectly blend of nepali home made spicies",
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text("Rs ${100 * a}", style: AppWidget.semiBoldTextFieldStyle()),
                                ],
                              ),
                              Container(
